...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--input-file', type=str, default='input_data/20210608_의정부지하상가1.csv', help='the input file')
    ...
    parser.add_argument('-o', '--output-file', type=str, default='result/20210608_의정부지하상가1.csv', help='the output file')
